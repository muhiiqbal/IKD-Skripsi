        ...
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Username">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="text-center mt-4 text-lg fs-6">
                <p class="text-gray-600">Tidak Mempunyai Akun? <a href="/register" class="font-bold">Sign up</a></p>
